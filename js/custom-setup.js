 ...
 *custome:
 * add 'direction' data to document.body
 * init() now give dirction to change direction of body
 *
 * Content:
...
;(function($, window, document, undefined)
{
    ...
    function handleResize()
    {
        ...
        console.log($.template.mediaQuery.isSmallerThan('tablet-portrait'));

        console.log($.template.mediaQuery.name);
        console.log($.template.mediaQuery.on);
    ...
    $.template.init = function(documentDirection)
    {
            // Objects
        var menu = $('#menu'),
        ...
        $('#open-menu').on('touchend click', function(event)
        {
            ...
            //bod.toggleClass($.template.mediaQuery.is('desktop') || $.template.mediaQuery.is('tablet-landscape') ? 'menu-open':'menu-hidden'  );
        ...
        watchMenuSize = function()
        {
            ...
            if ((!bod.hasClass('menu-open') || !$.template.mediaQuery.is('tablet-portrait')) && false)
            {
