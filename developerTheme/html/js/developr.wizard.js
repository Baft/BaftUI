...
;(function($, window, document)
{
	...
	$.fn.wizard.defaults = {
		 ...
		 * @var string
		 */
		controlPrev: '<button type="button" class="button glossy mid-margin-right wizard-next float-right">قبلی<span class="button-icon anthracite-gradient right-side"><span class="icon-forward"></span></span></button>',

		/**
		 * Next button markup - must use class 'wizard-next'
		 * @var string
		 */
		controlNext: '<button type="button" class="button glossy mid-margin-right wizard-previous float-left"><span class="button-icon blue-gradient"><span class="icon-backward"></span></span>ادامه</button>'
	};
