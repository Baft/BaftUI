                ...
                $.modal.all.each(function(i)
                    {
                        ...
                        if (data)
                            ...
                            data.setPosition(
                                modal.parseCSSValue('right')+widthChange,
        ...
        $.modal = function(options)
        {
            ...
            */
            setPosition = function(x, y, animate)
            {
                ...
                modal[animate ? 'animate' : 'css']({
                        right:	Math.min(Math.max(0, x), viewportWidth-modal.outerWidth()),
            ...
            */
            ...
            if (settings.useIframe)
                ...
                ((settings.contentAlign !== 'right') ? ' align-'+settings.contentAlign : '')+
            ...
            if (settings.resizable)
                ...
                handleResize = function(event)
                {
                    ...
                    // Position
                    setPosition(modalX+(resized.right*(offsetX+correctX)), modalY+(resized.top*(offsetY+correctY)));
                };
        ...
        */
        $.modal.defaults = {
            ...
            */
            ...
            /**
            * Alignement of contents ('right', 'center' or 'left') ignored for iframes
            * @var string
            */
            contentAlign: 'right',
            ...
            */
            ...
            /**
            * Actions leds on top right corner, with text as key and function on click or config object as value
            * Ex:
            *
            *  {
            ...
            */
            ...
            /**
            * Alignement of buttons ('right', 'center' or 'left')
            * @var string
            */
            buttonsAlign: 'left',
...
//                    $('.modal-buttons').find('button').click();
